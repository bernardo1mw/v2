    ...
    <div className="backgroundImage h-screen flex items-center justify-center">
      <div className="w-[500px] bg-[#fdf5ef] rounded-3xl flex">
        <Typography className="text-xl font-bold text-blue-900">
          ...
          namorando você ❤️ Quero agradecer por cada segundo do seu lado porque assim eu consigo expressar um pouquinho do que eu sinto, você é
          a coisinha mais especial do mundo todo. Amo você demais!
          <br />
