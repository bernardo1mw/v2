    ...
    <div className="backgroundImage h-screen flex items-center justify-center">
      <div className="w-[1000px] bg-[#fdf5ef] rounded-3xl flex">
        <Card className="w-1/3 mx-10">
          <Link href={{pathname: 'endPage',query: {
            restaurant: param,
            after: 'adv'
          }}}>
          ...
          <CardContent>
            ...
            <Typography variant="body2" color="text.secondary">
              Muitas montanhas, natureza, piscinas naturais e exercícios físicos
              hihihi
            </Typography>
          </CardContent>
          </Link>
        ...
        <Card className="w-1/3 mx-10">
          ...
          <CardContent>
            ...
            <Typography variant="body2" color="text.secondary">
              Ver um filminho, ficar bem enroladinha em mim e se amar muito bem coladinhos
            </Typography>
          </CardContent>
          </Link>
        </Card>
