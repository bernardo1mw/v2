        ...
        <Link href={{pathname: 'after', query: {
          ...
          <CardContent>
            ...
            <Typography variant="body2" color="text.secondary">
              Compaixão sem depender de outras espécies animais. Nossa filosofia
              é pratica de vida e compaixão. Pratos deliciosos churrascos
              saborosos que você encontra aqui na 1°Churrascaria Vegana do
              Brasil!!
            </Typography>
          </CardContent>
          </Link>
